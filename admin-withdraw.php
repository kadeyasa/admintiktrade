...
if(!isset($_GET['status'])){
	$results = getdatawithdraws($per_page,$start);
}else{
	$status = $_GET['status'];
	$results = getdatawithdraws($per_page,$start,$status);
}

$result_all = getdatawithdraws();
//echo json_encode($respone);
$totalpage = ceil(count($result_all)/$per_page);
include('header.php');
?>
<body>
				...
				<div class="row">	
					<div class="col-lg-3">
						<div class="card text-bg-primary mb-3" style="max-width: 18rem;">
  							<div class="card-header">
								...
								&nbsp;[&nbsp;<a href="admin-withdraw.php?status=1" style="color:#fff;">View</a>&nbsp;]
							</div>
  							<div class="card-body">
                    ...
                    <div class="col-lg-3">
						<div class="card text-bg-warning mb-3" style="max-width: 18rem;">
  							<div class="card-header">
								<b><i class="bi bi-currency-dollar"></i>&nbsp;Approved Withdraw</b>
								&nbsp;[&nbsp;<a href="admin-withdraw.php?status=2" style="color:#fff;">View</a>&nbsp;]
							</div>
  							<div class="card-body">
                    ...
                    <div class="col-lg-3">
						<div class="card text-bg-danger mb-3" style="max-width: 18rem;">
  							<div class="card-header">
								<b><i class="bi bi-currency-dollar"></i>&nbsp;Waiting Withdraw</b>
								&nbsp;[&nbsp;<a href="admin-withdraw.php?status=0" style="color:#fff;">View</a>&nbsp;]
							</div>
  							<div class="card-body">
                            	...
                            	<tbody>
                            		<?php
                                     ...
                                     <tr>
                                     	...
                                     	<td class="<?php echo $c;?>"><?php echo $row['address'];?></td>
                                     	<td class="<?php echo $c;?>"><?php echo $row['network'];?></td>
                                     	<td class="<?php echo $c;?>"><?php echo $row['tx_id'];?></td>
                                     	<td class="<?php echo $c;?>" align="center">
                                     		<?php if($row['status']==0){?>
											<a href="admin-withdraw.php?action=reject&id=<?php echo $row['id'];?>&status=0" onclick="return window.confirm('Are you sure?');">Reject</a>
                                            <a href="javascript:approvewd(<?php echo $row['id'];?>);" title="Approve">
                                     			<i class="bi bi-check2-square"></i>
                                            </a>
                                            <?php }else{
                                            	if($row['status']==2){
												?>
													<a href="admin-withdraw.php?action=delete&id=<?php echo $row['id'];?>&status=2" onclick="return window.confirm('Are you sure?');">Delete</a>
                                                <?php
    ...
    <!-- Modal -->
    <form method="post">                                               
	<div class="modal fade" id="modal-wd" tabindex="-1" aria-labelledby="modal-editLabel" aria-hidden="true">
